...
void NumberFormatTest::TestLocalizedPatternSymbolCoverage() {
    ...
    dfs.setSymbol(DecimalFormatSymbols::kGroupingSeparatorSymbol, u'\x2056');
    dfs.setSymbol(DecimalFormatSymbols::kDecimalSeparatorSymbol, u'\x2058');
    dfs.setSymbol(DecimalFormatSymbols::kPatternSeparatorSymbol, u'\x2059');
    dfs.setSymbol(DecimalFormatSymbols::kDigitSymbol, u'\x25b0');
    dfs.setSymbol(DecimalFormatSymbols::kZeroDigitSymbol, u'\xed0');
    dfs.setSymbol(DecimalFormatSymbols::kSignificantDigitSymbol, u'\x2055');
    dfs.setSymbol(DecimalFormatSymbols::kPlusSignSymbol, u'\x2020');
    dfs.setSymbol(DecimalFormatSymbols::kMinusSignSymbol, u'\x2021');
    dfs.setSymbol(DecimalFormatSymbols::kPercentSymbol, u'\x205c');
    dfs.setSymbol(DecimalFormatSymbols::kPerMillSymbol, u'\x2031');
    dfs.setSymbol(DecimalFormatSymbols::kExponentialSymbol, u"⁑⁑"); // tests multi-char sequence
    dfs.setSymbol(DecimalFormatSymbols::kPadEscapeSymbol, u'\x2042');
