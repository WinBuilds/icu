...
!IF "$(CFG)" != "Release" && "$(CFG)" != "release" && "$(CFG)" != "Debug" && "$(CFG)" != "debug" && "$(CFG)" != "Win32\Release" && "$(CFG)" != "Win32\Debug" && "$(CFG)" != "x64\Release" && "$(CFG)" != "x64\Debug"
...
RESNAME=uconvmsg
RESDIR=..\..\..\extra\uconv\resources
RESFILES=..\..\..\extra\uconv\resfiles.mk
ICUDATA=$(ICUP)\data
...
RB_FILES = ..\..\..\extra\uconv\resources\$(RES_FILES:.res =.res ..\..\..\extra\uconv\resources\)
RESOURCESDIR=
